...
const Navbar = () => {
    ...
    useEffect(() => {
        const fetchProfileInfo = async () => {
            try {
                const res = await fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/auth/get-user-info/${id}`, {
                    method : 'GET',
                    credentials : 'include'
                });
    ...
    try {
        const res = await fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/search/search-query?q=${encodeURIComponent(searchQuery)}`, {
            method: 'GET',
            credentials: 'include',
        });
