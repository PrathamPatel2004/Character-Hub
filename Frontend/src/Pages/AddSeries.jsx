...
const AddSeries = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const res = await fetch(`${process.env.VITE_API_BASE_URL}/api/categories/all-categories`, { method : 'GET' , credentials : 'include' });
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.VITE_API_BASE_URL}/api/series/add-series`, {
                method: 'POST',
                headers: {
