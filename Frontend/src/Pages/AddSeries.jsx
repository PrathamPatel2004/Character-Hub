...
const AddSeries = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const res = await fetch('http://localhost:5000/api/categories/all-categories', { method : 'GET' , credentials : 'include' });
    ...
    const uploadToCloud = async (file, single = true) => {
        ...
        if (single) {
            ...
            const res = await fetch('http://localhost:5000/api/upload/uploadFiles', { method: 'POST', body: formData, credentials: 'include' });
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await fetch('http://localhost:5000/api/series/add-series', {
                method: 'POST',
                headers: {
