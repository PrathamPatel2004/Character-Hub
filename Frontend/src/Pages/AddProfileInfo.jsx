...
const AddProfileInfo = () => {
    ...
    useEffect(() => {
        const fetchProfileInfo = async () => {
            try {
                const res = await fetch(`${process.env.VITE_API_BASE_URL}/api/auth/get-user-info/${id}`, {
                    method: 'GET',
                    credentials: 'include'
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.VITE_API_BASE_URL}/api/auth/add-profile-info`, {
                method: 'PUT',
                credentials: 'include',
                body: formDataToSend
            });
