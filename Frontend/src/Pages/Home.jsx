        ...
        const fetchData = async () => {
            try {
                const [categoriesRes, charactersRes, seriesDataRes, userDataRes] = await Promise.all([
                    fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/categories/all-categories`, { method: 'GET', credentials: 'include' }),
                    fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/characters/all-characters`, { method: 'GET', credentials: 'include' }),
                    fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/series/all-series`, { method: 'GET', credentials: 'include' }),
                    fetch(`${import.meta.env.REACT_APP_API_BASE_URL}/api/auth/allUsers`, { method: 'GET', credentials: 'include' }),
                ]);
