...
const AddCharacter = () => {
    ...
    useEffect(() => {
        ...
        const fetchSeries = async () => {
            try {
            const res = await fetch('http://localhost:5000/api/series/all-series', { method : 'GET' , credentials : 'include' });
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await fetch('http://localhost:5000/api/characters/add-character', {
                method: 'POST',
                headers: {
