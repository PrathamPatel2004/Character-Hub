...
const AddCharacter = () => {
    ...
    useEffect(() => {
        ...
        const fetchSeries = async () => {
            try {
            const res = await fetch('https://character-hub.onrender.com/api/series/all-series', { method : 'GET' , credentials : 'include' });
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await fetch('https://character-hub.onrender.com/api/characters/add-character', {
                method: 'POST',
                headers: {
