...
const AddCharacter = () => {
    ...
    useEffect(() => {
        ...
        const fetchSeries = async () => {
            try {
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/series/all-series`, { method : 'GET' , credentials : 'include' });
    ...
    const handleSubmit = async e => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.REACT_APP_API_BASE_URL}/api/characters/add-character`, {
                method: 'POST',
                headers: {
